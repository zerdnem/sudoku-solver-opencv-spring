...
import static com.example.filedemo.sudoku.SudokuFeatureDetector.CONTAIN_DIGIT_SUB_MATRIX_DENSITY;;

import static org.opencv.imgproc.Imgproc.*;

public class SudokuDetect {

    private Size FOUR_CORNERS = new Size(1, 4);

    private SudokuDetectDigit detect = new SudokuDetectDigit();
...
//
    ...
    private List<Integer> extractCells(Mat m) {
        ...
        List<Optional<Rect>> digitBoxes = Lists.transform(cells, SudokuFeatureDetector.GET_DIGIT_BOX_BYTE_SUM);
