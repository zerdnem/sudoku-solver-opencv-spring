...
import static com.example.filedemo.sudoku.SudokuDancingLinks.Cell;
...
public class SudokuSolver {
    ...
    private void decodeRow(SudokuBoard board, List<String> row) {
        Integer value = 0;
        Integer m_row = 0;
        Integer m_col = 0;
    ...
    public SudokuBoard solve() {
        SudokuDancingLinks x = new SudokuDancingLinks();
        ...
        SudokuBoard result = SudokuBoard.of(board.size);
